        ...
        generate: {
          ...
          html: function(source, id, url) {
            ...
            if((source && id) || url) {
              ...
              if(source == 'vimeo') {
                html = ''
                  + '<iframe srcsrc="//player.vimeo.com/video/' + id + '?=' + module.generate.url(source) + '"'
                ...
                html = ''
                  + '<iframe srcsrc="//www.youtube.com/embed/' + id + '?=' + module.generate.url(source) + '"'
                  + ' width="100%" height="100%"'
                  + ' frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>'
                ;
              }
  ...
  video: function(image) {
    ...
    if(image) {
      html += ''
        ...
        + '<img class="placeholder" srcsrc="' + image + '">'
      ;
    }
